...
//  FirstProject
//
//  Created by Bunti Nizama on 12/06/20.
...
class CardsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var cardContentView = ContentView()
        
        cardContentView.frame(width: cardView.frame.size.width, height: cardView.frame.size.height, alignment: .center)
